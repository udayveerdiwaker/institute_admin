            ...
            <div class="col-sm-5 col-md-6 mt-5">
                ...
                <form action="registration.php" method="POST">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" aria-label="First name" class="form-control p-3" placeholder="Type Here.."
                            name="fname" required onkeyup="capitalizeFirstLetter()" id="myInput">

                        <input type="text" aria-label="Last name" class="form-control p-3" placeholder="Type Here.."
                            name="lname" onclick="capitalizeFirstLetter()" id="myInput">
                    </div>
