...
if ($_SESSION == true) {
    ...
    header("location:http://localhost/institute_admin/exam-root/user_logins.php");
}
...
<body>
    ...
    <div class="container">
        ...
        <div class="card mt-3" id="heading">
            <h6 class="text-center mt-2 p-2 fs-5 display-6"><?php echo $_SESSION['fname'] ?> You Have To Select Only 1
                out of 4 .All The Best</h6>
        </div>


        <div class="col-lg-8 m-auto d-block mt-5" id="maindiv">
            <h3 class="h3text">Test Your Knowledge</h3>

            <div>
                <h1 class="display-6" style="font-weight: 900; font-size:60px">Website Banaye</h1>
                <h1 class="w3-red" style="text-align: center; font-weight: 700; font-size:40px">& Computer Sikhe</h1>
            </div>
            <!-- <ul>
            ...
            <div class="d-grid gap-2 col-6 mx-auto">
                ...
                <a class="btn  w3-blue-grey" href="examsection.php?n=<?php echo $n ?>" role="button">Start Exam</a>
            </div>
