...
if (isset($_GET['q'])) {
    ...
    $blocked = ['cp','child porn','childporn','child pornography','pedo','pedophile'];
...
<small><strong>(Query 1.65400 seconds)</strong></small>
        ...
        <div class="search-tabs">
            <div class="container">
                ...
                <?php if ($isBlocked): ?>
                <div class="row justify-content-left" style="margin-top:80px; margin-bottom:80px;">
                    <div class="col-md-8 text-center">

                        <h1 style="font-size:42px;">Not Found</h1>
                        ...
                        color:#444;
                    ">
                            <p>The page you requested does not exist or is restricted.</p>
                            <p>Illegal or harmful search terms are blocked.</p>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <ul>
                            <li class="<?php echo ($filename=='search.php')?"active":""; ?>">
                                <a href="search?q=<?= htmlspecialchars($searchText) ?>">All</a>
                            </li>

                            <li class="<?php echo ($filename=='clearweb.php')?"active":""; ?>">
                                <a href="clearweb?q=<?= htmlspecialchars($searchText) ?>">
                                    Clearnet <span class="beta">Beta</span>
                                </a>
                            </li>

                            <li class="<?php echo ($filename=='searchimg.php')?"active":""; ?>">
                                <a href="searchimg?q=<?= htmlspecialchars($searchText) ?>">Images</a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <head>
                    <title>Not Found - OnionLand</title> -->
                <style>
                /* .container {
                        text-align: center;
                        margin-top: 120px;
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <ul>
                                    ...
                                    <li class="<?php echo ($filename=='clearweb.php')?"active":""; ?>">
                                        <a href="clearweb?q=<?= htmlspecialchars($searchText) ?>">Clearnet<span
