...
<div class="main-content">
    <div class="container mt-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <a href="add_fees" class="btn btn-primary">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr class="text-center">
                            ...
                            <td>
                                <a href="view_fees_details?id=<?= $row['id']; ?>" class="btn btn-sm btn-info">
                                    <i class="bi bi-eye"></i>
                                </a>

                                <a href="edit_fees?id=<?= $row['id']; ?>" class="btn btn-sm btn-warning">
                                    <i class="bi bi-pencil-square"></i>
                                </a>

                                <a href="delete_fees?id=<?= $row['id']; ?>" class="btn btn-sm btn-danger"
                                    onclick="return confirm('Are you sure you want to delete this record?');">
                                    <i class="bi bi-trash"></i>
                                </a>
                                <a href="fees_receipt?id=<?= $row['id']; ?>" class="btn btn-sm btn-success"
                                    target="_blank">
