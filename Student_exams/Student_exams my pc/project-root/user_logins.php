...
if (isset($_POST['submit'])) {
    ...
    if ($total == 1)
    {
        ...
        header("location:http://localhost/project-root/dashboard.php");
            ...
            <div class="col-sm-5 col-md-6 mt-5">
                ...
                <form action="user_logins.php" method="POST">
                    ...
                    <span class="input-group-text" id="inputGroup-sizing-default">Username</span>
                        <input type="text" class="form-control p-3" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default"  placeholder="Type Here.." name="username">
                        <span class="error"><?php echo $nameError; ?></span>
                    </div>
                    <div class="input-group mb-3">
                    <span class="input-group-text" id="inputGroup-sizing-default">Password</span>
                    <input type="text" class="form-control p-3" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default"  placeholder="Type Here.." name="password">
