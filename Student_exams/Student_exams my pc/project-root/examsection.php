                                      ...
                                      foreach ($subject as $k => $x) {
                                        ...
                                        <div class="card mt-5 p-4" style="width: 30rem;   background-color:   lightblue">
                                                  <div class="card-body">
                                                            ...
                                                            <h6 class="card-subtitle mb-4 text-body-secondary text-center mt-4">Microsoft office Specialist</h6>
                                                            <?php $n= base64_encode('1')?>
                                                            <a href="questions.php?n=<?php echo $n?>&sub=<?php echo $x['sub']?>&Q=<?php echo $x['question_number']?>" class="card-link">Start Exam</a>
                                                  </div>
                                        </div>
                          <?php
                            }
