...
$institute_address = "Address Line, City, PIN";
$institute_phone = "9876543210";
$institute_email = "info@institute.example";
...
<head>
  ...
  <style>
    ...
    .receipt{max-width:800px;margin:20px auto;background:#fff;padding:24px;border:1px solid #eaeaea}
    .muted{color:#666}
...
<div class="receipt">
  ...
  <table class="table table-sm mt-3">
    ...
    <tbody>
      <tr><td>Total Fee</td><td class="text-end">₹<?= $total_fee ?></td></tr>
      <tr><td>Previous Paid</td><td class="text-end">₹<?= $prev ?></td></tr>
      <tr><td>Paid Now</td><td class="text-end">₹<?= $paid ?></td></tr>
      <tr><td><strong>Remaining</strong></td><td class="text-end"><strong>₹<?= $remaining ?></strong></td></tr>
    </tbody>
  </table>
