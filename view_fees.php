    ...
    <div class="container mt-4">
        <div class="card p-4 shadow-sm">
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-2"><strong>Remaining:</strong>
                    ₹<?= (isset($r['remaining']) ? $r['remaining'] : ($r['total_fee'] - $r['paid_amount'])) ?></div>
                <div class="col-md-6 mb-2"><strong>Mode:</strong> <?= htmlspecialchars($r['payment_mode']) ?></div>
                <div class="col-md-6 mb-2"><strong>Date:</strong> <?= $r['created_at'] ?? $r['payment_date'] ?? '' ?>
                </div>
