...
<div class="main-content">
    <div class="container mt-4">
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <div>
                <a href="fees_remaining?student_id=<?= $student_id ?>" class="btn btn-primary btn-sm">Add
                    Payment</a>
                <a href="fees_list" class="btn btn-secondary btn-sm">Back</a>
            </div>
        </div>
            ...
            if ($hist && mysqli_num_rows($hist) > 0) {
              while ($h = mysqli_fetch_assoc($hist)) {
                echo "<tr>
                        ...
                        <td>
                          <a href='fees_delete?id={$h['id']}&student_id={$student_id}' class='btn btn-sm btn-danger' onclick=\"return confirm('Delete this payment?')\">Delete</a>
                        </td>
                      </tr>";
                $i++;
              }
