...
?>
                        ...
                        <div class='col-md-6 mt-2'><strong>Admission Date:</strong>
...
?>
                ...
                <div class='card p-3 mb-3'>
                    <div class='d-flex justify-content-between align-items-center'>
                        <h5>Fees Summary</h5>
                        <div>
                            <a href="../fees/add_fees.php?student_id=<?= $student_id ?>"
                                class='btn btn-sm btn-primary'>Add
                                Payment</a>
                            <a href="../fees/remaining.php?student_id=<?= $student_id ?>"
                                class='btn btn-sm btn-info'>Add
                                Remaining</a>
                            <a href="../fees/combined_receipt.php?student_id=<?= $student_id ?>"
                                class='btn btn-sm btn-success' target='_blank'>Combined Receipt</a>
                            <a href="../fees/combined_receipt_pdf.php?student_id=<?= $student_id ?>"
                                class='btn btn-sm btn-danger' target='_blank'>Combined PDF</a>
                        </div>
                    </div>
...
?>
                        ...
                        <div class='col-md-4'><strong>Total Paid:</strong> ₹<?php echo number_format( $total_paid, 2 );
?>
                        </div>
                        <div class='col-md-4'><strong>Remaining:</strong> ₹<?php echo number_format( $overall_remaining, 2 );
?>
                        </div>
                    </div>
                </div>
