...
// fetch record
$q = mysqli_query($conn, "SELECT sf.*, s.student_name, c.course, c.fees AS course_fee
...
if (isset($_POST['update'])) {
    ...
    $remaining   = (float) $_POST['remainingEdit'];
    $payment_mode = mysqli_real_escape_string($conn, $_POST['payment_mode']);
    $remarks     = mysqli_real_escape_string($conn, $_POST['remarks']);

    $sql = "UPDATE student_fees SET student_id='$student_id', course_id='$course_id', total_fee='$total_fee',
            paid_amount='$paid_amount', remaining='$remaining', payment_mode='$payment_mode', remarks='$remarks' WHERE id=$id";

    if (mysqli_query($conn, $sql)) {
        $msg = "<div class='alert alert-success'>Payment updated.</div>";
        header("Location: student_fees.php?id=$id");
            ...
            <form method="post">
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" step="0.01" id="remainingEdit" name="remainingEdit" class="form-control" readonly>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <a href="view_fees_details.php" class="btn btn-secondary">Back</a>
                    </div>
                </div>
            </form>
        </div>
